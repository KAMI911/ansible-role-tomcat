...
<body>
<h1 class="title">
						<span class="en" id="title-en">This page is not public</span>
					<span class="de" id="title-de">Diese Seite ist nicht öffentlich</span>
					<span class="hu" id="title-hu">Ez az oldal nem nyilvános</span>
					<span class="ru" id="title-ru">Данная страница не является публичной</span>
			</h1>
<div class="errorBody">
	<div class="errorBox">
		<div class="errorData">
			...
			<div class="statusText">
															<span class="en">This page is not public</span>
											<span class="de">Diese Seite ist nicht öffentlich</span>
											<span class="hu">Ez az oldal nem nyilvános</span>
											<span class="ru">Данная страница не является публичной</span>
												</div>
		</div>
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							This site is not available for public viewing. Please see our <a href="/">site</a> for valid links to click.
						</span>
											<span class="de">
							Diese Seite ist nicht für öffentliche Betrachtung freigegeben. Bitte kehren sie zur <a href="/">Startseite</a> zurück um öffentliche Verweise zu finden.
						</span>
											<span class="hu">
							Ez az oldal nem olvasható nyilvánosan. Térjen vissza a <a href="/">nyitólapra</a> és keressen kattintható hivatkozásokat ott.
						</span>
											<span class="ru">
							Данный сайт не предназначен для публичного просмотра. Пожалуйста, просмотрите <a href="/">сайт</a> на наличие доступных для просмотра ссылок.
						</span>
												</div>
			<div class="tips todo">
									<h2>
