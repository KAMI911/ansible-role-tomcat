...
<body>
<h1 class="title">
						<span class="en" id="title-en">Not found</span>
					<span class="de" id="title-de">Nicht gefunden</span>
					<span class="hu" id="title-hu">Nem található</span>
					<span class="ru" id="title-ru">Не найдено</span>
			</h1>
<div class="errorBody">
	<div class="errorBox">
		<div class="errorData">
			...
			<div class="statusText">
															<span class="en">Page not found, sorry</span>
											<span class="de">Die Seite wurde nicht gefunden</span>
											<span class="hu">Az oldal nem található</span>
											<span class="ru">Станица не обнаружена</span>
												</div>
		</div>
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							The page you requested was <strong>not found</strong> on our servers.
						</span>
											<span class="de">
							Die gewünschte Seite wurde auf unserem Server <strong>nicht gefunden</strong>.
						</span>
											<span class="hu">
							A kért oldal <strong>nem található</strong> a szerverünkön.
						</span>
											<span class="ru">
							Запрошенная страница на наших серверах <strong>не найдена</strong>.
						</span>
												</div>
			<div class="tips todo">
									<h2>
