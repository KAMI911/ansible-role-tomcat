...
<body>
<h1 class="title">
						<span class="en" id="title-en">Method Not Allowed</span>
					<span class="de" id="title-de">Methode nicht erlaubt</span>
					<span class="hu" id="title-hu">Nem engedélyezett hozzáférési mód</span>
					<span class="ru" id="title-ru">Метод не поддерживается</span>
			</h1>
<div class="errorBody">
	<div class="errorBox">
		<div class="errorData">
			...
			<div class="statusCode">405</div>
			<div class="statusText">
															<span class="en">Your Browser sent an invalid request</span>
											<span class="de">Ihr Browser hat eine ungültige Anfrage geschickt</span>
											<span class="hu">A böngészője érvénytelen lekérdezést küldött</span>
											<span class="ru">Ваш браузер послал неверный запрос</span>
												</div>
		</div>
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							Your browser sent a request our server <strong>couldn't process</strong> because the access method it tried to use is invalid for this page. Please try again or follow the steps below to resolve this issue.
						</span>
											<span class="de">
							Ihr Browser hat versucht eine Abfragemethode zu verwenden die für diese Seite nicht genehmigt wurde. Bitte versuchen sie die Schritte unten um das Problem zu lösen.
						</span>
											<span class="hu">
							A böngészője olyan lekérdezési móddal fordult a szerverünkhöz, ami erre az oldalra nem engedélyezett. Próbálja meg a lenti lépéseket a probléma megoldása érdekében.
						</span>
											<span class="ru">
							Ваш браузер послал запрос, который наш сервер не в состоянии обработать в связи с тем, что примененный им метод доступа недоступен для данной страницы. Пожалуйста, попытайтесь снова или следуйте указаниям ниже для решения данной проблемы.
						</span>
												</div>
			<div class="tips todo">
									<h2>
					...
					<ul>
										...
										Вернитесь на <a href="/">домашнюю страницу</a> и попытайтесь снова.
													...
													<li>
																	<span class="en">
										If you typed the address for this site, check that you typed everything correctly.
									</span>
																	<span class="de">
										Wenn sie die Addresse eingetippt haben, kontrollieren sie diese auf Tippfehler.
									</span>
																	<span class="hu">
										Ha a címet kézzel adta be, ellenőrizze ezt gépelési hibákra.
									</span>
																	<span class="ru">
										При наборе адреса этого сайта, проверьте корректность набора.
									</span>
															</li>
											</ul>
							</div>
