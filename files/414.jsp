...
<body>
<h1 class="title">
						<span class="en" id="title-en">Request-URI Too Long</span>
					<span class="de" id="title-de">Die Addresse ist zu lang</span>
					<span class="hu" id="title-hu">A cím túl hosszú</span>
					<span class="ru" id="title-ru">Запрашиваемый URI слишком длинный</span>
			</h1>
<div class="errorBody">
	<div class="errorBox">
		<div class="errorData">
			...
			<div class="statusCode">414</div>
			<div class="statusText">
															<span class="en">Too long!</span>
											<span class="de">Zu lang!</span>
											<span class="hu">Túl hosszú!</span>
											<span class="ru">Адрес слишком длинный!</span>
												</div>
		</div>
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							Your browser sent us a waaaaay too long address and we couldn't process it.
						</span>
											<span class="de">
							Ihr Browser hat uns eien viiiiel zu lange Addresse geschickt die wir nicht verarbeiten konnten.
						</span>
											<span class="hu">
							A böngészője túl hosszú címet küldött, amit nem tudtunk feldolgozni.
						</span>
											<span class="ru">
							Ваш браузер послал нам слишком длинный адрес и мы не можем его обработать.
						</span>
												</div>
			<div class="tips todo">
									<h2>
