...
<body>
<h1 class="title">
						<span class="en" id="title-en">Expectation Failed</span>
					<span class="de" id="title-de">Erwartung nicht erfüllt</span>
					<span class="hu" id="title-hu">Követelmény nem teljesült</span>
					<span class="ru" id="title-ru">Ожидаемое неприемлемо</span>
			</h1>
<div class="errorBody">
	<div class="errorBox">
		<div class="errorData">
			...
			<div class="statusCode">417</div>
			<div class="statusText">
															<span class="en">Can&#039;t satisfy your expectations</span>
											<span class="de">Wir können den Erwartungen nicht entsprechen</span>
											<span class="hu">Nem tudnk megfelelni a követelményeknek</span>
											<span class="ru">Невозможно удовлетворить Ваши ожидания</span>
												</div>
		</div>
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							Your browser sent us an expectation we couldn't satisfy. Please try the steps below to resolve your issue.
						</span>
											<span class="de">
							Ihr Browser hat uns eine Erwartung geschickt die der wir nicht entsprechen können. Bitte versuchen sie die Schritte unten um das Problem zu lösen.
						</span>
											<span class="hu">
							A böngészője olyan követelményt küldött a lekérdezés során, amit nem tudunk teljesíteni. Kérem, próbálja meg az alábbi lépéseket a probléma orvoslása érdekében.
						</span>
											<span class="ru">
							Ваш браузер послал нам запрос, который мы не можем удовлетворить. Пожалуйста, следуйте указаниям ниже для решения проблемы.
						</span>
												</div>
			<div class="tips todo">
									<h2>
