...
<body>
<h1 class="title">
						<span class="en" id="title-en">Internal Server Error</span>
					<span class="de" id="title-de">Interner Serverfehler</span>
					<span class="hu" id="title-hu">Belső szerverhiba</span>
					<span class="ru" id="title-ru">Ошибка сервера Интернет</span>
			</h1>
<div class="errorBody">
	<div class="errorBox">
		<div class="errorData">
			...
			<div class="statusText">
															<span class="en">An error happened, sorry</span>
											<span class="de">Ein Fehler ist passiert</span>
											<span class="hu">Hiba történt</span>
											<span class="ru">Произошла ошибка</span>
												</div>
		</div>
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							Our server has encountered an error it can't recover from. Please try to trace back your steps. If the error persists, contact us.
						</span>
											<span class="de">
							Unser Server ist während der Verarbeitung auf einen Fehler gestoßen. Bitte versuchen sie ihre Schritte rückzuverfolgen. Wenn der Fehler weiterhin besteht, wenden sie sich bitte an uns.
						</span>
											<span class="hu">
							Az egyik szerverünk hibára futott. Próbálja meg visszakövetni a lépéseit. Ha továbbra is fennáll a hiba, értesítsen minket.
						</span>
											<span class="ru">
							Наш сервер столкнулся с ошибкой, невозможной для исправления. Пожалуйста, попытайтесь отследить Ваши действия. Если ошибка повторится, свяжитесь с нами.
						</span>
												</div>
			<div class="tips todo">
									<h2>
