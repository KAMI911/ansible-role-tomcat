	...
	<div class="errorBox">
		...
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							We are not able to process your request because our server has encountered an error in one of our background servers.
						</span>
											<span class="de">
							Wir können ihre Anfrage nicht bearbeiten weil einer unserer Hintergrundserver auf einen Fehler gelaufen ist.
						</span>
											<span class="hu">
							Az egyik háttérkiszolgáló hibára futott, ezért a lekérdezését nem tudjuk teljesíteni.
						</span>
											<span class="ru">
							Мы не в состоянии обработать Ваш запрос, так как наш сервер обнаружил ошибку одного из Ваших фоновых серверов.
						</span>
												</div>
			<div class="tips todo">
									<h2>
