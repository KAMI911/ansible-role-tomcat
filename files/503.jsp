	...
	<div class="errorBox">
		...
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							Our servers need love too, so we are performing scheduled maintenance at the moment. Please come back in a little while.
						</span>
											<span class="de">
							Unsere Server brauchen auch liebe, deshalb unternehmen wir grade Wartungsarbeiten. Bitte schauen sie in ein paar Minuten wieder zurück.
						</span>
											<span class="hu">
							A szervereknek is kell a szeretet, ezért jelenleg karbantartást végzünk. Nézzen vissza pár perc múlva.
						</span>
											<span class="ru">
							Наши серверы тоже нуждаются во внимании, поэтому в настоящий момент осуществляется их техническое обслуживание. Пожалуйста, обновите страницу позже.
						</span>
												</div>
			<div class="tips todo">
									<h2>
					...
					<ul>
										...
										Почитайте газетку.
													...
													<li>
																	<span class="en">
										<a href="" onclick="window.location.reload();return false;">Refresh this page</a>, maybe we're done already.
									</span>
																	<span class="de">
										<a href="" onclick="window.location.reload();return false;">Laden sie die Seite neu</a>, vieleicht sind wir schon fertig.
									</span>
																	<span class="hu">
										<a href="" onclick="window.location.reload();return false;">Frissítse az oldalt</a>, hátha már készen vagyunk.
									</span>
																	<span class="ru">
										<a href="" onclick="window.location.reload();return false;">Обновите страницу</a>, возможно, мы уже закончили.
									</span>
															</li>
											</ul>
							</div>
