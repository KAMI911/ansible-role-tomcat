...
<body>
<h1 class="title">
						<span class="en" id="title-en">Bad Gateway</span>
					<span class="de" id="title-de">Gateway Fehler</span>
					<span class="hu" id="title-hu">Átjáró hiba</span>
					<span class="ru" id="title-ru">Ошибочный шлюз</span>
			</h1>
<div class="errorBody">
	<div class="errorBox">
		<div class="errorData">
			...
			<div class="statusCode">504</div>
			<div class="statusText">
															<span class="en">Background Error</span>
											<span class="de">Hintergrundfehler</span>
											<span class="hu">Háttérkiszolgáló hiba</span>
											<span class="ru">Фоновая ошибка</span>
												</div>
		</div>
		<div class="errorDescription">
			<div class="description">
															<span class="en">
							We are not able to process your request because our background server is taking too long to respond.
						</span>
											<span class="de">
							Wir können ihre Anfrage nicht bearbeiten weil einer unserer Hintergrundserver zu langsam antwortet.
						</span>
											<span class="hu">
							Nem tudjuk teljesíteni a lekérést, mert az egyik háttérkiszolgáló túl lassan válaszol.
						</span>
											<span class="ru">
							Мы не в состоянии обработать Ваш запрос, так как наш фоновый сервер отвечает слишком долго.
						</span>
												</div>
			<div class="tips todo">
									<h2>
